...
function LoginContent() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#FBF8F5' }}>
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#FBF8F5' }}>
      {/* Navigation */}
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-20">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-12 animate-fade-in" style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
            <h1 className="text-4xl md:text-5xl font-medium tracking-tight mb-4">
              <span className="inline-flex flex-wrap justify-center items-center gap-2">
                ...
                <span className="bg-primary text-primary-foreground border border-foreground px-4 py-2 rounded-[20px]">
                  back
                </span>
              </span>
            </h1>
          ...
          {/* Login Card */}
          <div
            className="bg-white border border-foreground p-8 md:p-10 animate-fade-in"
            style={{ animationDelay: '0.2s', animationFillMode: 'both' }}
          >
            {error && (
              <div className="bg-destructive/10 text-destructive text-sm rounded-md p-4 mb-6 border border-destructive/20">
                {error}
              </div>
            )}
            ...
            <button
              ...
              className="w-full h-14 flex items-center justify-center gap-3 bg-foreground text-background text-base font-medium border border-foreground hover:bg-foreground/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      {/* Bottom decoration */}
      <div className="fixed bottom-0 left-0 right-0 h-2 bg-foreground"></div>
    </div>
  );
}
